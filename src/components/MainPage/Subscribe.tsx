...
const Subscribe = () => {
	return (
		<div
			...
			className="w-[85%] my-10 flex items-center justify-between border-solid border-[1px] border-[#b9bcbd] py-8 px-8 rounded-lg max-[1175px]:flex-col max-[1175px]:items-center max-[1175px]:justify-center max-[1175px]:text-center max-[750px]:w-full max-[750px]:p-3"
		>
